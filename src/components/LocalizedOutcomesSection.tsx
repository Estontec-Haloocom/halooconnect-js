      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {t("outcomes.headline")} <span className="text-gradient">Connect 6.0</span>
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          {outcomes.map((outcome) => (
            <div key={outcome.titleKey} className="text-center flex flex-col items-center">
              <CircleProgress
              ...
              <p className="text-muted-foreground text-xs md:text-sm">{t(outcome.descriptionKey)}</p>
            </div>
          ))}
        </div>
      </div>
