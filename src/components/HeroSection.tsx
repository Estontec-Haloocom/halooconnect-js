...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex flex-col justify-center pt-20 pb-8 md:pt-24 md:pb-16 overflow-hidden">
      {/* Background */}
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-4 animate-fade-in-up">
              ...
              <span className="text-xs font-semibold text-primary uppercase tracking-wide">#1 BEST CONTACT CENTER SOLUTION</span>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-6 animate-fade-in-up animation-delay-200">
              {channels.map((channel, i) => <div key={channel.label} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-secondary-foreground/5 border border-secondary-foreground/10" style={{
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6 animate-fade-in-up animation-delay-300">
              {benefits.slice(0, 4).map((benefit, index) => <li key={index} className="flex items-center gap-2 text-secondary-foreground/80">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 sm:gap-6 pt-4 border-t border-secondary-foreground/10 animate-fade-in-up animation-delay-400">
              {stats.map((stat, index) => <div key={stat.label} className="text-center flex-shrink-0">
